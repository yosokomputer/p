...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   asusKeygen: () => (/* binding */ asusKeygen),
/* harmony export */   asusSolver: () => (/* binding */ asusSolver)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AES128: () => (/* binding */ AES128),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TagE7A8Encoder: () => (/* binding */ TagE7A8Encoder),
/* harmony export */   TagE7A8EncoderSecond: () => (/* binding */ TagE7A8EncoderSecond),
/* harmony export */   blockEncode: () => (/* binding */ blockEncode)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DES: () => (/* reexport safe */ _latitude__WEBPACK_IMPORTED_MODULE_2__.DES),
/* harmony export */   DellTag: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_3__.DellTag),
/* harmony export */   calculateSuffix: () => (/* binding */ calculateSuffix),
/* harmony export */   dellHddSolver: () => (/* binding */ dellHddSolver),
/* harmony export */   dellLatitude3540Solver: () => (/* binding */ dellLatitude3540Solver),
/* harmony export */   dellSolver: () => (/* binding */ dellSolver),
/* harmony export */   hddOldSolver: () => (/* binding */ hddOldSolver),
/* harmony export */   keygenDell: () => (/* binding */ keygenDell),
/* harmony export */   latitude3540Keygen: () => (/* reexport safe */ _latitude__WEBPACK_IMPORTED_MODULE_2__.latitude3540Keygen)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/keygen/utils.ts");
...
function calculateSuffix(serial, tag, type) {
    ...
    var arr1;
    var arr2;
    if (type === 0 /* SuffixType.ServiceTag */) {
        arr1 = [1, 2, 3, 4];
        arr2 = [4, 3, 2];
    }
    else {
...
var dellSolver = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeSolver)({
    ...
    fun: function (password) {
        ...
        return keygenDell(password.slice(0, 7).toUpperCase(), suffix, 0 /* SuffixType.ServiceTag */);
    }
});
var dellHddSolver = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeSolver)({
    ...
    fun: function (password) {
        ...
        return keygenDell(password.slice(0, 11).toUpperCase(), suffix, 1 /* SuffixType.HDD */);
    }
});
...
/* harmony export */   latitude3540Keygen: () => (/* binding */ latitude3540Keygen)
/* harmony export */ });
/* eslint-disable no-bitwise */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DellTag: () => (/* binding */ DellTag)
/* harmony export */ });
var DellTag;
(function (DellTag) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fsi20DecNewSolver: () => (/* binding */ fsi20DecNewSolver),
/* harmony export */   fsi20DecOldSolver: () => (/* binding */ fsi20DecOldSolver),
/* harmony export */   fsi24DecSolver: () => (/* binding */ fsi24DecSolver),
/* harmony export */   fsi24Hex203cSolver: () => (/* binding */ fsi24Hex203cSolver),
/* harmony export */   fsiHexSolver: () => (/* binding */ fsiHexSolver)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/keygen/utils.ts");
...
function fsiHex203Cd001Keygen(serial) {
    ...
    var crc = new _cryptoUtils__WEBPACK_IMPORTED_MODULE_1__.Crc32();
    crc.update(serial.slice(8).split("").map(function (c) { return c.charCodeAt(0); }));
    // JAMCRC
    var output = ("0".repeat(8) + ((~crc.digest()) >>> 0).toString(16)).slice(-8);
    return [output];
}
...
var fsi24Hex203cSolver = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeSolver)({
    name: "fsi24Hex203c",
    description: "Fujitsu-Siemens Hex (6x4) 203c-d001-xxxx-xxxx-xxxx-xxxx",
    examples: ["203c-d001-0000-001d-e960-227d"],
    inputValidator: function (s) { return /^[0-9ABCDEF]{24}$/i.test(s); },
    fun: function (code) { return fsiHex203Cd001Keygen(code); }
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   hpAMISolver: () => (/* binding */ hpAMISolver)
/* harmony export */ });
/* harmony import */ var _cryptoUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cryptoUtils */ "./src/keygen/cryptoUtils.ts");
...
function hpAmiKeygen(input) {
    ...
    var crc = new _cryptoUtils__WEBPACK_IMPORTED_MODULE_0__.Crc32();
...
var hpAMISolver = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeSolver)({
    name: "hpAMI",
    description: "HP AMI",
    examples: ["A7AF422F"],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   hpMiniSolver: () => (/* binding */ hpMiniSolver)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/keygen/utils.ts");
...
/* harmony export */   solvers: () => (/* binding */ solvers)
/* harmony export */ });
...
var solvers = [
    ...
    _fsi__WEBPACK_IMPORTED_MODULE_3__.fsi24Hex203cSolver,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   acerInsyde10Solver: () => (/* binding */ acerInsyde10Solver),
/* harmony export */   hpInsydeSolver: () => (/* binding */ hpInsydeSolver),
/* harmony export */   insydeAcerSwitch: () => (/* binding */ insydeAcerSwitch),
/* harmony export */   insydeSolver: () => (/* binding */ insydeSolver)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/keygen/utils.ts");
/* harmony import */ var _cryptoUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cryptoUtils */ "./src/keygen/cryptoUtils.ts");
/* eslint-disable no-bitwise */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   phoenixFsiLSolver: () => (/* binding */ phoenixFsiLSolver),
/* harmony export */   phoenixFsiPSolver: () => (/* binding */ phoenixFsiPSolver),
/* harmony export */   phoenixFsiSSolver: () => (/* binding */ phoenixFsiSSolver),
/* harmony export */   phoenixFsiSolver: () => (/* binding */ phoenixFsiSolver),
/* harmony export */   phoenixFsiXSolver: () => (/* binding */ phoenixFsiXSolver),
/* harmony export */   phoenixHPCompaqSolver: () => (/* binding */ phoenixHPCompaqSolver),
/* harmony export */   phoenixSolver: () => (/* binding */ phoenixSolver)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/keygen/utils.ts");
/* eslint-disable no-bitwise */
...
function bruteForce(hash, salt, characters, minLen, maxLen) {
    ...
    if (hash > 0x3FFF) {
        return 0 /* PhoenixErrors.BadHash */;
    }
    var kk = 0;
    while (true) {
        kk++;
        if (kk > 7000000) {
            return 1 /* PhoenixErrors.NotFound */;
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   samsung44HexKeygen: () => (/* binding */ samsung44HexKeygen),
/* harmony export */   samsung44HexSolver: () => (/* binding */ samsung44HexSolver),
/* harmony export */   samsungSolver: () => (/* binding */ samsungSolver)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/keygen/utils.ts");
/* eslint-disable no-bitwise */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   sonySolver: () => (/* binding */ sonySolver)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/keygen/utils.ts");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   modularPow: () => (/* binding */ modularPow),
/* harmony export */   sony4x4Keygen: () => (/* binding */ sony4x4Keygen),
/* harmony export */   sony4x4Solver: () => (/* binding */ sony4x4Solver)
/* harmony export */ });
/* harmony import */ var jsbi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jsbi */ "./node_modules/jsbi/dist/jsbi-umd.js");
/* harmony import */ var jsbi__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jsbi__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/keygen/utils.ts");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   asciiToKeyboardEnc: () => (/* binding */ asciiToKeyboardEnc),
/* harmony export */   keyboardDict: () => (/* binding */ keyboardDict),
/* harmony export */   keyboardEncToAscii: () => (/* binding */ keyboardEncToAscii),
/* harmony export */   makeSolver: () => (/* binding */ makeSolver),
/* harmony export */   reversedScanCodes: () => (/* binding */ reversedScanCodes)
/* harmony export */ });
var __values = (undefined && undefined.__values) || function(o) {
    var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
    if (m) return m.call(o);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   monotonicTime: () => (/* binding */ monotonicTime)
/* harmony export */ });
...
/******/ })()
;
//# sourceMappingURL=bundle.411627e7ae43a8745b35.js.map